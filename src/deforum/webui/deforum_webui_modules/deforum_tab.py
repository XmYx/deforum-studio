            ...
            with st.expander("Basic Settings", expanded=True):
                ...
                st.session_state["txt2vid"]["max_frames"] = st.slider("Max Frames:", min_value=1, max_value=2048,
                                                                      value=st.session_state[
                                                                          'defaults'].txt2vid.max_frames, step=1)
        ...
        with col2:
            ...
            with rendering_tab:
                ...
                with sampler_tab:
                    ...
                    st.session_state["txt2vid"]["seed"] = st.text_input("Seed:",
                ...
                with sequence_tab:
                    ...
                    st.session_state["txt2vid"]["angle"] = st.text_input("Angle:", value=st.session_state[
                        'defaults'].txt2vid.angle)
                    st.session_state["txt2vid"]["zoom"] = st.text_input("Zoom:",
                    ...
                    st.session_state["txt2vid"]["noise_schedule"] = st.text_input("Noise Schedule:",
                                                                                  value=st.session_state[
                                                                                      'defaults'].txt2vid.noise_schedule)
                    st.session_state["txt2vid"]["strength_schedule"] = st.text_input("Strength Schedule:",
                                                                                     value=st.session_state[
                                                                                         'defaults'].txt2vid.strength_schedule)
                    st.session_state["txt2vid"]["contrast_schedule"] = st.text_input("Contrast Schedule:",
                                                                                     value=st.session_state[
                ...
                with flip_sequence_tab:
                    ...
                    st.session_state["txt2vid"]["perspective_flip_theta"] = st.text_input("Flip Theta:",
                                                                                          value=st.session_state[
                                                                                              'defaults'].txt2vid.perspective_flip_theta)
                    st.session_state["txt2vid"]["perspective_flip_phi"] = st.text_input("Flip Phi:",
                                                                                        value=st.session_state[
                                                                                            'defaults'].txt2vid.perspective_flip_phi)
                    st.session_state["txt2vid"]["perspective_flip_gamma"] = st.text_input("Flip Gamma:",
                                                                                          value=st.session_state[
                                                                                              'defaults'].txt2vid.perspective_flip_gamma)
                    st.session_state["txt2vid"]["perspective_flip_fv"] = st.text_input("Flip FV:",
                                                                                       value=st.session_state[
                ...
                with frames_tab:
                    ...
                    with mask_tab:
                        ...
                        st.session_state["txt2vid"]["mask_contrast_adjust"] = st.number_input('Contrast Adjust',
                                                                                              value=st.session_state[
            ...
            with settings_tab:
                ...
                st.session_state["txt2vid"]["frame_interpolation_engine"] = st.selectbox('Interpolation Engine',
                                                                                         ("FILM", "None"),
                                                                                         index=0,
                                                                                         help="",
                                                                                         key='interp-txt2vid')
        ...
        with col3:
            ...
            with st.expander("Animation", expanded=True):
                ...
                st.session_state["txt2vid"]["far_plane"] = st.number_input('Far Plane',
                                                                           ...
                                                                           step=1)
                st.session_state["txt2vid"]["fov"] = st.number_input('FOV',
                ...
                st.session_state["txt2vid"]["extract_nth_frame"] = st.number_input('Extract Nth Frame',
                                                                                   ...
                                                                                   step=1)
                st.session_state["txt2vid"]["interpolate_key_frames"] = st.checkbox('Interpolate Key Frames',
                                                                                    value=False)
                st.session_state["txt2vid"]["interpolate_x_frames"] = st.number_input('Number Frames to Interpolate',
                                                                                      ...
                                                                                      step=1)
                st.session_state["txt2vid"]["resume_from_timestring"] = st.checkbox('Resume From Timestring',
                                                                                    value=False)
                st.session_state["txt2vid"]["resume_timestring"] = st.text_input("Resume Timestring:",
                                                                                 value=st.session_state[
