                    ...
                    if uploaded_file:
                        try:
                            ...
                            for key, value in uploaded_data.items():
                                setattr(st.session_state['defaults'].txt2vid, key, value)
