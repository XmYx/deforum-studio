...
# Collect VENV_PATH
if [ $SILENT -eq 0 ]; then
    read -p "Enter virtual environment path (default: $VENV_DIR): " VENV_INPUT
...
# Collect ROOT_PATH
if [ $SILENT -eq 0 ]; then
    read -p "Enter root directory path (default: $ROOT_DIR): " ROOT_INPUT
...
# Collect COMFY_PATH
if [ $SILENT -eq 0 ]; then
    read -p "Enter ComfyUI directory path (default: $COMFY_DIR): " COMFY_INPUT
